...
df_feat <- func_create_features(df)
...
model_cont <- func_fit_model_episode(df_feat, continuous_episode = TRUE)
model_cat <- func_fit_model_episode(df_feat, continuous_episode = FALSE)
...
df_pred_cont <- func_add_prediction(df_feat, model_cont)
res_cont <- func_evaluate_model(df_pred_cont)

df_pred_cat <- func_add_prediction(df_feat, model_cat)
res_cat <- func_evaluate_model(df_pred_cat)
...
source(here("R", "poc_episode_resolution.R"))
